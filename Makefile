build/version:  build/7.4-nginx build/7.4-apache build/7.3-nginx build/7.3-apache build/7.2-nginx build/7.2-apache build/7.1-nginx build/7.1-apache build/7.0-nginx build/7.0-apache build/5.6-nginx build/5.6-apache
	date > build/version

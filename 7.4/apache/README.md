# php7.4-fpm + apache2 + mariadb
Docker image based on the image `php:7.4-fpm` with apache added on, this is for my personal use but if you have any suggestions please add an issue or create a pull request
...
```yaml
  web:
    image: dgoring/php-stack:7.4-apache
    restart: always
    volumes:

# php7.3-fpm + nginx + mariadb
Docker image based on the image `php:7.3-fpm` with nginx added on, this is for my personal use but if you have any suggestions please add an issue or create a pull request
...
```yaml
  web:
    image: dgoring/php-stack:7.3-nginx
    restart: always
    volumes:
